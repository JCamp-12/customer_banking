...
def main():
    ...
    # print("savings interest rate: ", savings_interest)
    savings_maturity = int(input("How many months has your savings been earning interest? "))
    # print("months: ", savings_maturity)
    ...
    # ADD YOUR CODE HERE
    print("Interest Earned on savings: $", interest_earned_savings)
    ...
    cd_interest = float(input("What is the interest on your CD? "))
    # print("cd interest: ", cd_interest)
    cd_maturity = int(input("How many months is your CD for? "))
    ...
    # ADD YOUR CODE HERE
    print("Interest Earned on CD: $", interest_earned_cd)
